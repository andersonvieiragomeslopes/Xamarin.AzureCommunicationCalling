...
namespace MauiACSTestSample.Screensharing.Android
{
    public class FrameGenerator : Java.Lang.Object, IVideoFrameSenderChangedListener, ImageReader.IOnImageAvailableListener
    {
        ...
        private ByteBuffer GenerateFrame(ByteBuffer plane)
        {
            ...
            try
            {
                ...
                Java.Lang.Thread.Sleep((long)(1000.0f / videoFormat.FramesPerSecond));
            }
        ...
        public void OnImageAvailable(ImageReader reader)
        {
            ...
            if (ConferenceManagerSpecificPlatformService.outgoingVideoStreamState == OutgoingVideoStreamState.Started)
            {
